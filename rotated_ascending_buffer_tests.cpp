...
// compile uising: 
// g++ rotated_ascending_buffer.cpp rotated_ascending_buffer_tests.cpp -DUTESTS -o rotated_ascending_buffer_tests

#include "utest.h"
#include "rotated_ascending_buffer.h"


class ArrayRABWrapper : public RotatedAscendingBufferWrapper {
    ...
    UTEST(find_max, empty_buffer) {
        ...
        int result = RotatedAscendingBufferUtils::find_max_index(w);
